...
public class BarChartExample {
    ...
    private static DefaultCategoryDataset createDataset(double[] valores, String[] categorias) {
    ...
    private static JFreeChart createChart(DefaultCategoryDataset dataset,String T,String x,String y) {
